...
<nav>
    ...
    <div class="form-container">
        <form action="myticket_sts.php" method="POST">
            <div class="form-group">
                 <input type="text" id="phone" name="phone" placeholder="Enter your phone number">
            </div>
            <div class="form-group">
                 <input type="number" id="train_id" name="train_id" placeholder="Enter train id">
            </div>
            <div class="form-group">
                <a href="myticket_sts.php"><button type="submit">View ticket</button></a>
            </div>
            </form>
    </div>
