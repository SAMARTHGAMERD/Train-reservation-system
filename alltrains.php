...
<nav>
    ...
    <div class="form-container">
        <form action="alltrain_sts.php" method="POST">
            <div class="form-group">
                 <input type="text" id="train_name" name="train_name" placeholder="Enter the train name">
            </div>
            
            <div class="form-group">
                <a href="alltrain_sts.php"><button type="submit">Search train</button></a>
            </div>
            </form>
        </div>
